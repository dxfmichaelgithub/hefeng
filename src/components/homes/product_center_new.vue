    ...
    <div class="container">
      ...
      <div id="carousel-example-generic4" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="item" :class="classOne">
              <div class="row">
                <div class="col-md-3">
                  <div class="product-post">
                    <div class="product-post-gal">
                      <img alt="" src="@/assets/img/product1.png">
                ...
                <div class="col-md-3">
                  <div class="product-post">
                    <div class="product-post-gal">
                      <img alt="" src="@/assets/img/product2.png">
                ...
                <div class="col-md-3">
                  <div class="product-post">
                    <div class="product-post-gal">
                      <img alt="" src="@/assets/img/product3.png">
                ...
                <div class="col-md-3">
                  <div class="product-post">
                    <div class="product-post-gal">
                      <img alt="" src="@/assets/img/product4.png">
          ...
          <div class="item" :class="classTwo">
              <div class="row">
                <div class="col-md-3">
                  <div class="product-post">
                    <div class="product-post-gal">
                      <img alt="" src="@/assets/img/product5.png">
                      <span class="price">$99.00</span>
                    </div>
                    <div class="product-post-content">
                      <h5>现货供应电解铜 电镀专用电解铜</h5>
                      <ul class="product-list">
                        <li><a class="like" href="#"><i class="fa fa-heart"></i></a></li>
                        <li><a class="shop" href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        <li><a class="rev" href="#"><i class="fa fa-exchange"></i></a></li>
                ...
                <div class="col-md-3">
                  <div class="product-post">
                    <div class="product-post-gal">
                      <img alt="" src="@/assets/img/product6.png">
                ...
                <div class="col-md-3">
                  <div class="product-post">
                    <div class="product-post-gal">
                      <img alt="" src="@/assets/img/product7.png">
                      <span class="price">$60.00</span>
                    </div>
                    <div class="product-post-content">
                      <h5>75#硅铁硅铁加工块孕育剂</h5>
                ...
                <div class="col-md-3">
                  <div class="product-post">
                    <div class="product-post-gal">
                      <img alt="" src="@/assets/img/product8.png">
                      <span class="price">$55.00</span>
                    </div>
                    <div class="product-post-content">
                      <h5>500目磷铁现货</h5>
        ...
        <!-- Controls -->
        <a @click="left()" class="left carousel-control" data-slide="prev"></a>
        <a @click="right()" class="right carousel-control" data-slide="next"></a>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    classOne () {
      return this.currentClass(1)
    },
    classTwo () {
      return this.currentClass(2)
    }
  },
  mounted () {
    this.init()
  ...
  methods: {
    ...
    currentClass (index) {
      return {
        ...
        next: this.currentIndex !== index && this.leftClicked,
        prev: this.currentIndex !== index && this.rightClicked,
        left: this.leftFired,
        right: this.rightFired
      }
    },
    left () {
...
<style scoped>
  ...
  .carousel-control.left {
    right: 28px;
    left: auto;
    background: rgba(19, 158, 186, 0.3);
    cursor: pointer;
  }
